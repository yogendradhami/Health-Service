...
if(isset($_POST['Submit'])){
    ...
    $sql="INSERT INTO blood_signup(firstname,middlename,lastname,email,contactno,password,dateofbirth,gender,bloodgroup,city,image) values ('$firstname','$middlename','$lastname','$email','$contactno','$hpassword','$dateofbirth','$gender','$bloodgroup','$city','$imagefilename')";
   $query=mysqli_query($conn,$sql);
   if($query){
   	echo "<script>alert('You have created your account Sucessfully')</script>";
   }
